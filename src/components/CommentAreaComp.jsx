  ...
  async function fetchAllComment(bookObj) {
    try {
      const response = await fetch("https://striveschool-api.herokuapp.com/api/comments/" + bookObj.asin, {
        headers: {
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTczMzUwZmZlMDMxZTAwMTliYTE3NWIiLCJpYXQiOjE3MDQ3MjQzNDQsImV4cCI6MTcwNTkzMzk0NH0.6_5WPGME8hfnzD2PYGy8OOm-G3q09mdvdeJ4itqwsf4",
        },
      });
